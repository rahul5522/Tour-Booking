...
},{"@babel/polyfill":"dTCHC","../js/login":"7yHem","./logout":"1ftRF","../js/updateUser":"575AG","./bookTour":"7d23e","../js/signup":"fNY2o"}],"dTCHC":[function(require,module,exports) {
"use strict";
...
const bookTour = async (tourID)=>{
    //   console.log(tourID);
    const response = await (0, _axiosDefault.default).get(`http://127.0.0.1:3000/api/v1/booking/create-payment-session/${tourID}`);
    //   console.log(response.data.url);
    window.location = response.data.url;
};

},{"axios":"jo6P5","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"fNY2o":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"axios":"jo6P5","./alert":"kxdiQ","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["hTzJ5","f2QDv"], "f2QDv", "parcelRequire7e89")
